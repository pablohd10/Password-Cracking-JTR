...
archivos=("minus_hashed_5.txt" "mayus_hashed_5.txt" "num_hashed_5.txt"
          "alfanum_simb_hashed_5.txt" "palabras_hashed_1.txt" 
          "palabras_hashed_2.txt" "palabras_hashed_3.txt"
          "palabras_hashed_4.txt" "palabras_hashed_5.txt")

# Loop a través de los archivos
for archivo in "${archivos[@]}"; do
    echo "ATAQUE FUERZA BRUTA INCREMENTAL ASCII LONGITUD 5"
